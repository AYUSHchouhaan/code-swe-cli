 ...
 * - Timeout handling
 */
const TEST_DIR = path_1.default.join(__dirname, 'temp-bash-test');
...
async function runTests() {
    ...
    let failed = 0;
    setupTestDir();
    const bashTool = (0, bash_1.createBashTool)(TEST_DIR);
    ...
    try {
        ...
        const fileExists = fs_1.default.existsSync(path_1.default.join(TEST_DIR, 'created.txt'));
        if (fileExists) {
...
//# sourceMappingURL=test.bash.js.map